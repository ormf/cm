...
(sprout (list (simp 100 60 90 .25 .2 .5 0)
...
;; can use ms:output to send individual MidiEv objects directly to
...
;; amp will be 0-1, so
;; TRY:
;;   1 write the expression that converts .5 to INTEGER MIDI velocity
;;;    Remember that the function FLOOR converts float to interger:
...
;; whenever there is input available. MidiShare hooks are always given a
